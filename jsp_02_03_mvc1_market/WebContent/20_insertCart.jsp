...
<body>
	<%
		...
		int buy_count = 0;
		if(request.getParameter("buyCnt") != null){
			buy_count = Integer.parseInt(request.getParameter("buyCnt"));
		}
	...
	<%	}else{
			if(item_stock > 0){
				boolean check = CartDAO.getInstance().checkItem(buyer, item_name);
				if(check == true){
					CartDAO.getInstance().updateCatr(buyer, item_name, buy_count);
				}else{
