...
<body>
		...
		<c:if test="${cnt > 0}">
			...
			<c:forEach var="buy" items="${buyList}">
				...
				<td width="50" align="center">
					<img src="img/${buy.item_image}" height="50">
				</td>
				<td width="100" align="center">
					<font size="2">${buy.item_name}</font>
				</td>
				<td width="50" align="center">
					<font size="2">${buy.buy_count}</font>
				</td>
				<td width="100" align="center">
					<font size="2" >${buy.buy_price*buy.buy_count}</font>
				</td>
				<td width="200" align="center">
					<font size="2">${buy.buy_date}</font>
				</td>
				<td width="150" align="center">
					<font size="2">${buy.howpay}</font>
				</td>
			</tr>
			</c:forEach>
		</table>
