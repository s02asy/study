...
<body>
	...
	<script>
		function checkInput() {
			...
			if (document.f2.account.value != "1234"
					&& document.f2.account.value != "4321") {
	...
	<form name="f2" action="Ex08Pro.jsp">
		...
		<br> 이체할 금액을 입력하세요. <br>
		<br> <input type="text" name="money"> <input
			type="hidden" name="myMoney" value=<%=myMoney%>> <input
			type="hidden" name="yourMoney" value=<%=yourMoney%>> <br>
		<br> <input type="button" onclick="checkInput()" value="이체">
	</form>
