				...
				<table>
					<tr height="40">
						...
						<td width="40" align="center">
							<input type="image" src="img/delete.png" onclick="location.href='${cp}/_21_deleteCart.do?cart_number=${bean.getCart_number()}'">
						</td>
					</tr>
				</table>
	
				<hr size="1" color="gray" width="680">
				<c:set var="total" value="${total+ bean.getBuy_count() * bean.getBuy_price()}"/>
			</c:forEach>
		</c:if>
			
			
			<form method="post" action="${cp}/_22_order.do?center=22_order.jsp">
				<table>
					<tr height="30">
