<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<br>
	<form method="post" action="09_joinPro.jsp" accept-charset="utf-8">
		<table>
			<tr height="50">
				<td width="150"><b>아이디</b></td>
				<td width="300" align="center"><input type="text" name="id" placeholder="id입력" style="width:300px; height:40px"></td>
			</tr>
			
			<tr height="50">
				<td width="150"><b>비밀번호</b></td>
				<td width="300" align="center"><input type="password" name="pw" placeholder="pw입력" style="width:300px; height:40px"></td>
			</tr>
