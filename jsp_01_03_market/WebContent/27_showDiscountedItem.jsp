...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<h1>알뜰 상품</h1>
	<font size="2" color="purple">20%이상 할인 제품</font>
	<br><br>
	<!-- 테이블 안은 16showallcategory랑 아예 똑같음 -->
	<table>
		<%
			for(int i = 0; i < discountedItem.size(); i++){
				ItemDTO bean = discountedItem.get(i);
		...
		%>
				<td width="400" align="center">
					<a href="00_shopMain.jsp?center=18_showOneItem.jsp
					&item_number=<%=bean.getItem_number()%>&item_image=<%=bean.getItem_image()%>">
		<%
